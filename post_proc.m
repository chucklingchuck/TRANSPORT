...
for i = 1 : num_reg - 1
    ...
    % Plot
    figure
    [dirs_left_sorted,r] = sort(dirs_left);
    psi_left_sorted = psi_left(r);
    left_plot = plot(dirs_left_sorted, psi_left_sorted, '--s');
    set(left_plot, 'LineWidth', 1.0, 'MarkerSize', 10);
    hold all;
    [dirs_right_sorted,r] = sort(dirs_right);
    psi_right_sorted = psi_right(r);
    right_plot = plot(dirs_right_sorted, psi_right_sorted, '--s');
    set(right_plot, 'LineWidth', 1.0, 'MarkerSize', 10);
    grid on
